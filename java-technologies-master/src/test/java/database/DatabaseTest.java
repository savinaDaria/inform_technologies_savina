...
class DatabaseTest {
    ...
    void projectTable() {
        ...
        assertSame(Result.Status.OK, database.query("insert into test1 (id, name) values(1, cat)").getStatus());
        assertSame(Result.Status.OK, database.query("insert into test1 (id, name) values(2, dog)").getStatus());
